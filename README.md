...
| exercise 3 | Verify if a specific checkbox is checked | 1. Access the main page <br> 2. Select the component container and find the ".item-content" inside. <br> 3. Locate tag <p> with text "Test2" until to the parent of the "<p> element". <br> 4. Find a checkbox inside and assert is checked | Find the second line with "Text2" with a checked box. |
